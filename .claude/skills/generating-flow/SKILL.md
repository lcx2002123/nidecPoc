...
description: >
  ...
  questions only, or non-Flow declarative config (use generating-custom-object or generating-custom-field).
license: MIT
metadata:
  version: "2.1.0"
...
- creating objects / fields first → [generating-custom-object](../generating-custom-object/SKILL.md)
...
| expose Flow to Agentforce | sf-ai-agentscript (Agentforce skill) | agent action orchestration |
| build Approval Process routing or multi-step approval workflows | [building-approval-processes](../building-approval-processes/SKILL.md) | approval workflow design |
